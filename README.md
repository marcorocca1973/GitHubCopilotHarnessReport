...
"Using the last agent report create an interactive html dashboard that highlight the main insights. In this dashboard use interactive filters and charts"
